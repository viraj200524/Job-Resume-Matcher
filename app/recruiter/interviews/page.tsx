      ...
      <div className="container mx-auto p-6 bg-grid">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
          <div>
            ...
            <p className="text-muted-foreground">Manage your upcoming and past candidate interviews</p>
          </div>
          <Button asChild className="mt-4 md:mt-0 bg-gradient-to-r from-blue-600 to-cyan-500 text-white">
            <Link href="/recruiter/candidates">Schedule New Interview</Link>
          </Button>
        </div>
        ...
        {loading ? (
          ...
          <Card className="border-0 shadow-md rounded-xl overflow-hidden">
            <CardHeader>
              ...
              <CardDescription>You don't have any upcoming interviews with candidates</CardDescription>
            </CardHeader>
            <CardContent className="flex flex-col items-center justify-center py-8">
              ...
              <Button asChild className="bg-gradient-to-r from-blue-600 to-cyan-500 text-white">
                <Link href="/recruiter/candidates">Schedule an Interview</Link>
              </Button>
            </CardContent>
          </Card>
        )}
