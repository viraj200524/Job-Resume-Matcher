      ...
      <div className="container mx-auto p-6 bg-grid">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
          <div>
            ...
            <p className="text-muted-foreground">Set up an interview for application #{applicationId}</p>
          </div>
        </div>
        ...
        <div className="max-w-2xl mx-auto">
          <Card className="border-0 shadow-md rounded-xl overflow-hidden gradient-border">
            <CardHeader>
              ...
              <CardDescription>Schedule an interview for this application</CardDescription>
            </CardHeader>
            <CardContent>
